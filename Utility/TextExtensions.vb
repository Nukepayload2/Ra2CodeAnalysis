...
Namespace AnalysisHelper
    Public Module Extensions
        ...
        Public Function GetText(Root As IEnumerable(Of Imaging.MainKeyTreeNode), Generator As Type) As String
            Dim sb As New StringBuilder(";<生成的代码(生成器:=" + If(Generator?.FullName, "null") + ",版本:=" + If(Generator.GetTypeInfo.Assembly.GetCustomAttribute(Of AssemblyFileVersionAttribute)?.Version, "null").ToString + ")>" & vbCrLf)
            For Each s In Root
