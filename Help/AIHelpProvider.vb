...
Public Class AIHelpProvider
    ...
    Public Shared AIHelp As New Dictionary(Of String, String) From {{"VeteranLevel", "<已过时> 地图文件中指定此小队出现在地图时的兵种等级"},
{"MindControlDecision", "<不明确> 遭心灵控制后的动作，0自动，1加入控制者作战小队，2送入部队回收厂，3送入生化反应炉，4搜索敌人，5什么也不做"},
{"Loadable", "<不明确> 可装载"},
{"Full", "<不明确> <已过时> 创建小队成员的时候，如果小队中有运载工具，其他成员是否应该位于运载工具的内部"},
{"Annoyance", "<不明确> 烦恼效果，作用不明"},
{"GuardSlower", "<不明确> 降低反应速度，作用不明"},
{"Recruiter", "强制重组优先级较低的小队的成员，如果它们是可以重组的"},
{"Autocreate", "<不明确> 自动建造"},
{"Prebuild", "<不明确> 预先建造，作用不明"},
{"Reinforce", "<不明确> <已过时> 增援部队"},
{"Droppod", "<已过时> 地图文件中指定使用空降进入战区"},
